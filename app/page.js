...
import { handleGoogleSignIn } from './hooks/handlers';
  ...
  return (
    ...
    '>
      ...
      <div className='absolute top-4/5 left-1/2 -translate-x-1/2 -translate-y-1/2 
        ...
        <Link href='/onboarding'><button className='cursor-pointer px-10 py-3 rounded-full bg-white text-black font-semibold 
                     hover:bg-gray-200 hover:shadow-[0_0_20px_rgba(255,255,255,0.4)] 
                     transition-all active:scale-95'>
          Student
        </button></Link>

        <Link href='/onboarding'><button className='cursor-pointer px-10 py-3 rounded-full border border-white/30 text-white 
